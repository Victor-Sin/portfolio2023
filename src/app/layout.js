...
export const metadata = {
  ...
  description: "Victor Sin is a creative developer based in Paris, crafting immersive WebGL & WebGPU experiences, interactive installations, and expressive web interfaces. Explore the portfolio.",
  ...
  openGraph: {
    ...
    title: "Victor Sin — Creative Developer | WebGL & WebGPU Portfolio",
    description: "Discover the portfolio of Victor Sin, a creative developer based in Paris — immersive WebGL & WebGPU experiences, interactive installations, and expressive web interfaces.",
    images: [
      {
        url: "/images/og-image.webp",
        width: 1200,
        height: 630,
        alt: "Victor Sin — Creative Developer Portfolio",
      },
    ],
  },
  twitter: {
